...
2. Download the data using [1_weather_data_download.py](python_code/weather/1_weather_data_download.py)
3. Preprocess the data using [2_daily_summaries.py](python_code/weather/2_daily_summaries.py)
